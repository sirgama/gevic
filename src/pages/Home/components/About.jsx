...
export default function About() {
  return (
    <div>
      <div className='bg-gray-900 mx-auto max-w-screen-2xl py-2 md:py-4 px-2 lg:px-2 lg:py-0 rounded-3xl mt-6'>
      <p className="text-orange-800/75 px-2 md:px-20 font-bold pt-8">- About us</p>
        ...
        <div className='w-full h-96'>
            <img src={about} className='relative w-full h-full object-cover object-top shadow-lg shadow-orange-900/25 rounded-3xl opacity-50 my-10' alt="" />
        </div>
