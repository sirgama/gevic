...
export default function Footer() {
  return (
    <div>
      <div className='bg-gray-900 mx-auto max-w-screen py-2 md:py-4 px-2 lg:px-2 lg:py-0 rounded-3xl mt-6'>
  
        <footer className="p-4 bg-inherit rounded-3xl sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
                <img src={Logo} className="mr-3 h-8" alt="Gevic logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-white"></span>
            </a>
            <p className="text-gray-300 font-normal text-sm sm:w-1/3 py-6">We got a huge selections for the Schools and office. Find our extensive range of Diaries, Calendars, adhesives, copier paper, envelopes, exercise books, notepads, pens, whiteboards and much, much more.</p>
